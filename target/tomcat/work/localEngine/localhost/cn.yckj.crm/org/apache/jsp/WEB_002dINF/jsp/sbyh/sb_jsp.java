...
public final class sb_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t<a class=\"weui-navbar__item weui-bar__item--on\" href=\"#tab1\">\r\n");
      out.write("\t\t\t\t\t问题填报\r\n");
      out.write("\t\t\t\t</a>\r\n");
      out.write("\t\t\t</div>\r\n");
      ...
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath}", java.lang.String.class, (PageContext)_jspx_page_context, null, false));
      out.write("/problem/sbreceived.action\" method=\"post\" enctype=\"multipart/form-data\">\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t<h2>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<select name=\"systemtype\" id=\"systemtype\" class=\"weui-input\" onchange=\"modeList()\" >\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<option >请选择申报系统</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</select>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</h2>\r\n");
      out.write("\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t<div class=\"weui-cell__bd\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<h2>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<select name=\"pmodule\" id=\"pmodule\" class=\"weui-input\" >\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<option >请选择问题模块</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</select>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</h2>\r\n");
      out.write("\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t<h2>问题描述</h2></div>\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"weui-cell\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"weui-cell__bd\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<textarea id=\"pdesc\" name=\"pdesc\" class=\"weui-textarea\" placeholder=\"请输入文本\" rows=\"3\" maxlength=\"200\" onkeyup=\"changeLen()\"></textarea>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"weui-textarea-counter\"><span id=\"length\">0</span>/200</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"weui-cells weui-cells_form\">\r\n");
      ...
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"weui-uploader__bd\"><input type=\"file\" name=\"upfiles\"/>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"weui-uploader__bd\"><input type=\"file\" name=\"upfiles\"/>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"weui-uploader__bd\"><input type=\"file\" name=\"upfiles\"/>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t<div>\r\n");
      out.write("\t\t\t\t\t\t\t\t<input type=\"submit\" value=\"问题提交\" />\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t</form>\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("\r\n");
